...
SettingsTab:Section('Hotbar Settings')
SettingsTab:Comment('Use these for when you die and your item is unquipped')



SettingsTab:Toggle('Use Auto-Hotbar', function(v)
    UseHotbar = v
end)
